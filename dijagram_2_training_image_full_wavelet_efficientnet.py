...
def train_model(fold=None):
    ...
    datagen = ImageDataGenerator(preprocessing_function=preprocess_input)  # EfficientNetB0's preprocess_input

    # Generator for training data
    train_generator = datagen.flow_from_directory(train_dir, target_size=(224, 224), batch_size=32, class_mode='categorical')  # Updated

    # Generator for testing data
    test_generator = datagen.flow_from_directory(test_dir, target_size=(224, 224), batch_size=32, class_mode='categorical')  # Updated

    # Load base model
    base_model = EfficientNetB0(weights='imagenet', include_top=False)  # Updated
